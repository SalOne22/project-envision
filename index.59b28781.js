function e(e){return e&&e.__esModule?e.default:e}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},i={},o=t.parcelRequire34ff;null==o&&((o=function(e){if(e in a)return a[e].exports;if(e in i){var t=i[e];delete i[e];var o={id:e,exports:{}};return a[e]=o,t.call(o.exports,o,o.exports),o.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){i[e]=t},t.parcelRequire34ff=o),o("bUb57");var n=o("e0qAQ"),r=o("3OIsu"),s=o("bh4hP"),l=o("b3SuP");const c=async()=>{let e="",t="background-size: cover";try{let{results:a}=await (0,n.fetchTrendingMoviesByDay)(),{id:i,title:o,overview:c,backdrop_path:d,vote_average:u}=a[Math.floor(20*Math.random())],p=`https://image.tmdb.org/t/p/original/${d}`;window.innerWidth<768&&(t="background-size: 768px; background-position: center"),e=`
      ...
      </div>`,s.heroRefs.heroContainer.innerHTML=e;let _=document.getElementById("watch-trailer");_.addEventListener("click",e=>(0,r.onTrailerBtnClick)(e));let h=document.querySelector(".hero__btn.m-modal");h.addEventListener("click",()=>(0,l.onOpenModalFilmById)(h.dataset.id))}catch(t){(0,s.heroRefs).heroContainer.classList.toggle("hero--bg"),e=`
      ...
      </div>`,s.heroRefs.heroContainer.innerHTML=e}};c();var d=o("7Y9D8"),u=o("2shzp"),d=o("7Y9D8");const p={method:"GET",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjY2FhN2IzMjk5NmM0N2RhMTQxZWI1N2IwZTVjZTQ3NiIsInN1YiI6IjY0N2M5OTdkZTMyM2YzMDEyNzUyM2IzNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Blrs7t4WoJ6-3sy6A_Vz3twkTCmEg9nM0JyuAHg88WM"}};async function _(){try{let e=await (0,u.default).get("https://api.themoviedb.org/3/movie/upcoming",p);return e.data}catch(e){console.error(e),(0,d.Notify).failure("Oops! Something went wrong. Try again, please!")}}var h=o("2eUFK"),g=o("8Emoy");let m="";const v=e(h).genres,f=document.querySelector(".upcoming");_().then(e=>{!function({results:e}){let t;let a=Math.floor(Math.random()*e.length),{backdrop_path:i,genre_ids:o,id:n,overview:r,popularity:s,release_date:l,title:c,vote_average:d,vote_count:u}=e[a];t=[],o.forEach(e=>{v.forEach(a=>{e===a.id&&t.push(a.name)})}),m=t.length>2?`${t[0]} and others...`:2===t.length?`${t[0]}, ${t[1]}`:`${t[0]}`,f.innerHTML=`<div class="container">
        ...
        <ul class="list upcoming__list-info">
          <li class="upcoming__list-info--left">
            <div class="upcoming__release-date">
              ...
              <p class="upcoming__release-date--value">${l}</p>
            </div>
