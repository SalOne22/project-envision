function e(e){return e&&e.__esModule?e.default:e}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},i={},o={},a=t.parcelRequire34ff;null==a&&((a=function(e){if(e in i)return i[e].exports;if(e in o){var t=o[e];delete o[e];var a={id:e,exports:{}};return i[e]=a,t.call(a.exports,a,a.exports),a.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){o[e]=t},t.parcelRequire34ff=a),a("bUb57"),a("cOOEs");var n=a("7Y9D8"),l=a("2shzp"),n=a("7Y9D8");const s={method:"GET",headers:{accept:"application/json",Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjY2FhN2IzMjk5NmM0N2RhMTQxZWI1N2IwZTVjZTQ3NiIsInN1YiI6IjY0N2M5OTdkZTMyM2YzMDEyNzUyM2IzNiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.Blrs7t4WoJ6-3sy6A_Vz3twkTCmEg9nM0JyuAHg88WM"}};async function r(){try{let e=await (0,l.default).get("https://api.themoviedb.org/3/movie/upcoming",s);return e.data}catch(e){console.error(e),(0,n.Notify).failure("Oops! Something went wrong. Try again, please!")}}var c=a("2eUFK"),u=a("8Emoy");let p="";const d=e(c).genres,g=document.querySelector(".upcoming");r().then(e=>{!function({results:e}){let t;let i=Math.floor(Math.random()*e.length),{backdrop_path:o,genre_ids:a,id:n,overview:l,popularity:s,release_date:r,title:c,vote_average:m,vote_count:_}=e[i];t=[],a.forEach(e=>{d.forEach(i=>{e===i.id&&t.push(i.name)})}),p=t.length>2?`${t[0]} and others...`:2===t.length?`${t[0]}, ${t[1]}`:`${t[0]}`,g.innerHTML=`<div class="container">
    ...
    </div>`,function(){let e=document.querySelector("#addToMyLibrary");(0,u.default)(e)}()}(e)}).catch(t=>{console.error(t),e(n).Notify.failure("Oops! Something went wrong. Try again, please!")});var c=a("2eUFK"),m=a("hmX5O"),_=a("76tat");const h={movieList:document.querySelector(".list-movie-card")};var l=a("2shzp");const v={headers:{Authorization:"Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkMmFhZDQ4MjlkYjI1ZWQ1Mjc0NmY0NmY4YzQ1NzRlYSIsInN1YiI6IjY0NzIzZDc3OWFlNjEzMDBjNGM3NmY1NCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.v_Pd0M6hpO0qy1_8-nNBGtFxbeHjE8i8mgfszlHvjZc",accept:"application/json"}};async function f(e=1){try{let t=await (0,l.default).get(`https://api.themoviedb.org/3/trending/movie/week?language=en-US&page=${e}`,v);return t.data}catch(e){console.error(e)}}var y=a("b3SuP");if(h.movieList){let t={};e(c).genres.forEach(e=>{t[e.id]=e.name}),function(e){f().then(t=>{(function({results:e},t){let i=function(e){let t=[];for(;t.length<3;){let i=Math.floor(Math.random()*e.length);t.includes(i)||t.push(i)}return t}(e),o=i.map(t=>e[t]);(function(e){h.movieList.innerHTML=e.map(m.default).join(""),(0,_.default)();let t=document.querySelector(".list-movie-card.js-gallery");t.addEventListener("click",e=>{let t=e.target.closest(".m-modal");if(!t)return;let i=t.dataset.id;(0,y.onOpenModalFilmById)(i)})})(o,t)})(t,e)}).catch(e=>console.error(e))}(t)}a("1Hrz4"),a("5kw5v");
